...
# from P001_fitQ 
from data_processing.fitting.P001_fitQ import getData, printFitQResult
...
if __name__ == '__main__':
    ...
    ind = 4
    trim = 1
    filepath = fr'Z:\Data\NIST_LC\2022-08-05_000{ind}_r{ind}_s21.ddh5'
    (freq, real, imag, mag, phase) = getData(filepath, plot_data=0, method = 'vna_2')
    ltrim = trim  # trims the data if needed
    rtrim = trim  # keep this value greater than 1
    ...
    popt, pcov = fit(freq, real, imag, mag, phase, Qguess=(1e2, 1e3), delta=10e6, magBackGuess=1e-2)  # (ext, int)
