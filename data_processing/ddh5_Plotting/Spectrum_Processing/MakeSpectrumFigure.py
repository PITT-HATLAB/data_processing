...
ax.fill_between(x, lorentzian(x,0, 1, 6)+0.5, 0.5, alpha = 0.5, color = 'gray', label = 'detector band')
ax.fill_between(x, lorentzian(x,-1, 1, 0.5)+0.5, 0.5, alpha = 0.5, color = 'red', label = 'digital filter')
ax.fill_between(x, np.heaviside(x, 0), color = 'blue', alpha = 0.5, label = 'Image-Reject Mixer')
ax.set_ylim(0, 2)
...
ampgain = 0.25
signal = 1
idler = 2*ampgain-signal
dfilt = signal
detector = 0
IR = 0
x = np.linspace(-3, 3, 1000)
ax.fill_between(x, lorentzian(x, ampgain, 1, 3), alpha = 0.5, label = 'amplifier gain')
ax.fill_between(x, lorentzian(x, detector, 1, 6)+0.5, 0.5, alpha = 0.5, color = 'gray', label = 'detector band')
ax.fill_between(x, lorentzian(x,dfilt, 1, 0.5)+0.5, 0.5, alpha = 0.5, color = 'red', label = 'digital filter')
ax.fill_between(x, np.heaviside(x, IR)/2, color = 'blue', alpha = 0.5, label = 'Image-Reject Mixer')
ax.set_ylim(0, 2)
ax.arrow(idler, 0, 0, 0.9, width = 0.05)
ax.arrow(signal, 0, 0, 0.9, width = 0.05)
ax.arrow(0, 0.2, -1, 0, width = 0.03, length_includes_head = True, color = 'k')
# ax.grid()
ax.vlines(0, 0, 1, linestyle = 'dashed', color = 'red')
ax.set_xticks(ticks = [0])
ax.set_xticklabels(['$\omega_0 = 6GHz$'])
ax.get_yaxis().set_visible(False)
ax.annotate('Signal', [signal, 1.1])
ax.annotate('Idler', [idler, 1.1])
ax.annotate('$\Delta = 1MHz$', [-0.5, 0.25], [-0.60, 0.3])
ax.legend(bbox_to_anchor=(1.05, 1.0), loc='upper left')
# ax.annotate('Pump', [1.9, 0.96] )
